 ...
 * @author Keaton
 */
public class Midfielders extends Position{
    int cleanSheet, total = 0;
    Scanner sc = new Scanner(System.in);

    public Midfielders(int cleanSheet, String name, int timePlayed, int numGoals, int numAssists, int numMissedPens, int numOwnGoals, int card) {

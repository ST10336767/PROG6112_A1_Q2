 ...
 * @author Keaton
 */
public class Defenders extends Position{
    int  numGoalsConceded, cleanSheet, total = 0;
    Scanner sc = new Scanner(System.in);
    
    
    
    public Defenders(int cleanSheet, int numGoalsConceded, String name, int timePlayed, int numGoals, int numAssists, int numMissedPens, int numOwnGoals, int card) {
